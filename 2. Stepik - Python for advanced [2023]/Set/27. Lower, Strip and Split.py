# Using the set generator, augment the above code to get a set containing unique words (in lowercase)
# of the sentence string. Output the result on one line in alphabetical order, 
# separating the elements with one space character.

# Note. Note that punctuation marks do not refer to words.
...
'''
print(*sorted(set(word.lower().strip(':,.!?();') for word in sentence.split())))